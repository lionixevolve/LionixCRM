...
INSERT INTO email_templates
(id, date_entered, date_modified, modified_user_id, created_by, published, name, description, subject, body, body_html, deleted, assigned_user_id, text_only, `type`)
VALUES('01abcdef-efef-efef-efef-efefefefefef', utc_timestamp(), utc_timestamp(), '1', '1', 'off', 'z_WF_NOT_OP_SALES_STAGE_CHANGE', 'This template is used to send notifications to opportunty assigned user.', 'LionixCRM - Oportunidad $opportunity_name requiere tu atención', 'La oportunidad $opportunity_name requiere tu atención
