lx.field.visible = function (field_name, display, fnCallerName = "") {
    ...
    if (display) {
        console.warn(
            `lx.field.visible setting css visibility to visible on field %c${field_name} %c${fnCallerName}`,
            "color: blue",
            "color: green"
        );
        ...
        $(`.label[data-label='LBL_${field_name.toUpperCase()}']`).css(
            "visibility",
            "visible"
        );
        $(
        ...
        console.warn(
            `lx.field.visible setting css visibility to hidden on field %c${field_name} %c${fnCallerName}`,
            "color: blue",
            "color: green"
        );
