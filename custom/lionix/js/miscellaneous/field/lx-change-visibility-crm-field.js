lx.field.visible = function(field_name, display, fnCallerName = "") {
    ...
    if (display) {
        console.warn("lx.field.visible setting css visibility to visible on field " + field_name, fnCallerName);
        $("#" + field_name).css("visibility", "visible");
        $("#" + field_name).parent("div").parent("div").css("visibility", "visible");
        ...
        console.warn("lx.field.visible setting css visibility to hidden on field " + field_name, fnCallerName);
        $("#" + field_name).css("visibility", "hidden");
        $("#" + field_name).parent("div").parent("div").css("visibility", "hidden");
