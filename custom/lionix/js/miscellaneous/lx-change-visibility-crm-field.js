function lxChangeVisibilityCRMfield(field_name, display, fnCallerName = "") {
    ...
    if (display) {
        console.log("lxChangeVisibilityCRMfield setting css visibility to visible on field " + field_name, fnCallerName);
        ...
        console.log("lxChangeVisibilityCRMfield setting css visibility to hidden on field " + field_name, fnCallerName);
