...
function post_installModules()
{
    ...
    $query = "ALTER TABLE cases_cstm add COLUMN elapsedtimeinmins_c varchar(255) DEFAULT '0' NULL";
    $db->query($query);
    $query = "INSERT INTO fields_meta_data (id,name,vname,comments,help,custom_module,type,len,required,default_value,date_modified,deleted,audited,massupdate,duplicate_merge,reportable,importable,ext1,ext2,ext3,ext4) VALUES ('Caseselapsedtimeinmins_c','elapsedtimeinmins_c','LBL_ELAPSEDTIMEINMINS','This time is calculated on schedulers with function WORKDAY_TIME_DIFF_HOLIDAY_TABLE','This time is calculated on schedulers with function WORKDAY_TIME_DIFF_HOLIDAY_TABLE','Cases','varchar','255','0','0',utc_timestamp(),'0','0','0','0','1','false','','','1','')";
    $db->query($query);
