...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your LionixCRM credentials are missing.',
    ...
    'HDR_LOGIN_PANEL' => 'Please enter your LionixCRM Login credentials.',
    ...
    'LBL_ADMIN_WIZARD' => 'Easily setup your LionixCRM system',
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by LionixCRM',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the LionixCRM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your LionixCRM application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUP_TITLE' => 'Online Backups',
    'LBL_BACKUP' => 'Schedule backups to the LionixCRM Online Data Vault.  Activate a system restoration from backup.',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup LionixCRM files',
    'LBL_BROWSE' => 'Browse',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the LionixCRM Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'LionixCRM config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'LionixCRM Custom directory',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the LionixCRM Password Management feature settings will apply.',
    ...
    'LBL_MASSAGE_MASS_EMAIL_DESC' => 'LionixCRM requires an update to the Mass Email data.  Click "Begin Update" to continue.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing LionixCRM Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling LionixCRM Dashlet ',
    ...
    'LBL_OFFLINE_CLIENT' => 'View Offline Clients that are connected to this LionixCRM system',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the LionixCRM Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'LionixCRM Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing LionixCRM Dashlets cache and scanning known directories for LionixCRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild LionixCRM Dashlets',
...
//BEGIN SUGARCRM flav=een
    'LBL_REBUILD_EXPRESSIONS_DESC' => 'Rebuilds LionixCRM Logic functions cache',
    'LBL_REBUILD_EXPRESSIONS_TITLE' => 'Rebuild LionixCRM Logic Functions',
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_ORACLE_VARCHAR_DESC_LONG_1' => 'The following queries should be run against your database.  Run them manually with the client of your choice or click the "Commit" button to have LionixCRM run the queries immediately.',
    ...
    'LBL_UPGRADE' => 'Check and repair LionixCRM',
    ...
    'LBL_SUGARPORTAL' => 'LionixCRM Portal',
    'LBL_SUGARPORTAL_DESC' => 'Manage the LionixCRM Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, LionixCRM Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear LionixCRM Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing LionixCRM Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUGARFEEDCACHE' => 'Clear LionixCRM Feed Cache',
    'LBL_QR_CLEARSUGARFEEDCACHE' => 'Clearing LionixCRM Feed Cache...done',
...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_COLOUR_DESC' => 'Customise your LionixCRM theme to match your branding.',
    'LBL_COLOUR_ADMIN_INTRO' => 'Change these settings to customise your LionixCRM theme. <strong>Note:</strong> Please remember to refresh (Ctrl + F5) once you have saved your settings.',
