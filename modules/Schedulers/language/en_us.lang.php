...
// Labels
    ...
    'LBL_MODULE_NAME' => 'LionixCRM Scheduler',
...
// Messages
    ...
    'LBL_CRON_LINUX_DESC' => 'Note: In order to run LionixCRM Schedulers, add the following line to the crontab file: ',
    'LBL_CRON_WINDOWS_DESC' => 'Note: In order to run the LionixCRM schedulers, create a batch file to run using Windows Scheduled Tasks. The batch file should include the following commands: ',
...
//jobstrings
    ...
    'LBL_TRIMSUGARFEEDS' => 'Prune LionixCRM Feed Tables',
